---
title: PUNNARAJ Public Home
tags: [home, public, punaraj]
...
PUNNARAJ is a preservation-first project: a living effort to hold memory, intent, decisions, and working context in a form that can be revisited by humans and AI workers without depending on a single conversation, device, or moment in time.
...
1. Capture important thoughts, decisions, and structures in Markdown.
2. Link notes together using wiki links so context remains connected.
3. Build the vault into a static website for durable publication.
4. Check generated links and required pages before publishing.
5. Keep improving the workspace as new understanding arrives.
...
[[mud/index|Open the MUD workspace]]
